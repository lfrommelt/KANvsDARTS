...
from src.train_darts import train_new_darts
                        ...
                        for seed in range(3):
                            ...
                            for combination in range(6):
                                ...
                                if (
                                    k == 0
                                    and (combination > 0)
                                    and (not linear_transformations)
                                ):
                                    continue
                                for size in range(max(k - 1, 1), k + 3):
                                    ...
                                    config["param_learning_rate_min"] = (
                                        config["param_learning_rate_max"]
                                        * config["coeff_lr_min_scale"]
                                    )
                                    ...
                                    ) * 0.25  # one-fifth of data will be test
                                    ...
                                    monitor, model, predicted_equation, outcome = (
                                        train_new_darts(
                                            config,
                                            dataset,
                                            training_seed=seed,
                                    ...
                                    predicted_equation = round_and_simplify(
                                        predicted_equation, ndigits=4
                                    )
